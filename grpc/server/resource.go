...
func GenerateSnapshot(r *resources.AllResources) *cache.Snapshot {
	...
	helper.PrettyPrinter(r.Extensions)
	snap, err := cache.NewSnapshot(r.Version,
		map[resource.Type][]types.Resource{
			resource.ClusterType:         {makeCluster(ClusterName)},
			resource.RouteType:           {r.Route},
